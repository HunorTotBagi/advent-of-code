...
namespace Day04_Scratchcards
{
    public class task04test
    {
        ...
        {
            // Arrange
            var filePath = AppDomain.CurrentDomain.BaseDirectory + "../../../../aoc/day04-scratchcards/data/" + fileName;
        ...
        {
            // Arrange
            string filePath = AppDomain.CurrentDomain.BaseDirectory + "../../../../aoc/day04-scratchcards/data/testData.txt";
            List<string> scratchboards = card.ReadFileToList(filePath);
        ...
        {
            // Arrange
            string filePath = AppDomain.CurrentDomain.BaseDirectory + "../../../../aoc/day04-scratchcards/data/" + fileName;
            List<string> scratchboards = card.ReadFileToList(filePath);
